...
profundidadeBytes     = 2
qtdCanais             = 4
caminhoCSVDataset     = "/home/pi/Downloads/datasets/SESA_v2_"+str(int(freqAmostragem/1000))+"kHz_"+str(int(profundidadeBytes*8))+"bits_"+str(int(tempoJanela*1000))+"ms_58features_desescalonado_remocaoSilencio.csv"
